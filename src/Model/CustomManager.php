...
class CustomManager extends AbstractManager
{
    ...
    public function insertConfig(array $item): void
    {
        $statement = $this->pdo->prepare("INSERT INTO " . self::TABLE . " (name_moto, couleur_moto, couleur_retro, couleur_sellle, prix_moto, prix_retro, prix_selle)  
